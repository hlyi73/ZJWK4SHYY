...
<script type="text/javascript">
    $(function () {
    	...
    	if("no" == "${dataFlg}"){
    		$("#analytics_oppty_yearcompare").html("没有找到数据");
    		$("#analytics_oppty_yearcompare").css("padding-top","80px");
    		$("#analytics_oppty_yearcompare").css("min-height","200px");
    	}else{
	        $('#analytics_oppty_yearcompare').highcharts({
	        	  chart: {
	                  zoomType: 'xy'
	              },
	              title: {
...
<body>
	...
	<div id="analytics_div" class="view site-recommend">
		<div class="recommend-box">
			<!-- <h4>详情</h4> -->
			<form name="yearcompare"
				action="<%=path%>/analytics/oppty/yearcompare?openId=${openId}&publicId=${publicId}" method="post"
				novalidate="true">
				<div
				...
				<div class="site-card-view">
					<div class="card-info">
						<div id="analytics_oppty_yearcompare"
