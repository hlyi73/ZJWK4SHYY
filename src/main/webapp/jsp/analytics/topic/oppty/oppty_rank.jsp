...
<body>
		...
		<div class="list-group-item-bd" style="width: 180px; margin: 0 auto; padding-top: 5px;">
			<p>
				<div class="form-control select _viewtype_select">
					<div class="select-box viewtypelabel" style="color:#000">业务机会阶段停留分析</div>
				</div>
			</p>
		</div>
	</div>
	...
	<div class="_viewtype_menu_class" id="_viewtype_menu_" style="width:100%;padding:10px;background-color:#fff;display:none;text-align:left;font-size:14px;"> 
		...
		<a href="<%=path%>/analytics/oppty/yearcompare?openId=${openId}&publicId=${publicId}">
		<div style="float:right;padding:10px;width:50%;">
	...
	<div id="analytics_div" class="view site-recommend">
		<div class="recommend-box">
				<!-- <h4>详情</h4> -->
		<form name="rankForm" action="<%=path%>/analytics/oppty/rank?openId=${openId}&publicId=${publicId}" method="post">
						...
						<table style="border:1px solid #EEEEEE;margin:0px;width:100%;">
							<tbody>
								<tr style="border-bottom:1px solid #EEEEEE;background-color:#EEEEEE;">
									...
									<c:forEach items="${opptyList}" var="rk">
