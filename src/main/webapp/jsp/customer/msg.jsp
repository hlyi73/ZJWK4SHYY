		...
		<div class="view site-phonebook">
			<div class="well text-center wrapper" style="padding: 2em 0">
				<c:if test="${success eq 'ok'}">
				    <h3 class="text-info" style="font-size: 18px;">创建客户成功!</h3>
				    <br>客户已同步到CRM<br>您同时可以登陆CRM系统中查看！<br><br>
				      <form name="detailForm" action="<%=path%>/customer/detail" method="post" novalidate="true" >
				...
				<c:if test="${success eq 'fail'}">
				    <h3 class="text-info" style="font-size: 18px;color:red">创建客户失败!</h3>
