	...
	<div id="cust_baseInfo" style="margin:5px 0px 0px 0px;">
		...
		<input type="hidden" name="orgId" value="${orgId}" />
				<div class="zjwk_form_row_div">
					...
					<input name="name" onfocus="setStyle($(this))"  style="height:50px;width: 99%" placeholder="客户姓名">
				</div>
				<div style="clear: both;"></div>
				<div class="zjwk_form_row_div">
					<input name="phoneoffice"  onfocus="setStyle($(this))"  style="height:50px;width: 99%" placeholder="联系方式">
				</div>
				<div style="clear: both;"></div>
				<div class="zjwk_form_row_div">
				...
				<div style="clear: both;"></div>
				<div class="zjwk_form_row_div">
					<input name="desc"  style="height:50px;width: 99%" placeholder="客户情况">
				</div>
		</form>
	</div>
	<!-- 底部菜单 -->
