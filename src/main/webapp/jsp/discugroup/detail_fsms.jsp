...
<script src="<%=path%>/scripts/model/discugroup_detail_fsms.model.js" type="text/javascript"></script>
<!--框架样式-->
...
<div class="_topic_list_{{id}}" style="padding: 10px; border: 1px solid #ddd;background-color: #fff;margin: 5px;">
  ...
  {{/if}}
	...
	<div class="reply_con " topicid="{{id}}"
		style="text-align: left; border-top: 1px solid #DFDCDC; margin-top: 10px; padding-top: 5px;">
		<p>
			<span>&nbsp;</span> 
            <span style="float: right; color: #2CB6F7;">
				<span class="sendMsg">发言</span>
				{{if '${dg.creator}' != '${curr_user.party_row_id}' && ess_flag != '1'}}
					&nbsp;&nbsp;&nbsp;<span class="_recommess " topictype="{{topic_type}}" topicid="{{id}}">推荐加精</span>
				{{/if}}
            	{{if '${dg.creator}' == '${curr_user.party_row_id}' && ess_flag != '1'}}
		...
		<p>
		<div class="reply_content" style="line-height: 35px;">
		</div>
...
<body>
	...
	<div id="discugroup_detail" style="font-size: 14px; margin: 0px;">
		...
		<!-- 标题-->
		<div
			style="width: 100%; line-height: 70px; background-color: #fff; border-bottom: 1px solid #E7E7E7;">
		...
		<!-- 公告区域-->
		<div
			style="width: 100%; line-height: 70px; background-color: #fff; border-bottom: 1px solid #E7E7E7; padding-left: 5px;">
			<div style="width:100%;">
		...
		<div class="tabbtns" style="width: 100%; line-height: 35px; background-color: #fff;">
			<div class="user "
				style="width: 25%; text-align: center; float: left; margin-top: 1px; text-align: center;">成员(1)</div>
			<div class="topic tabselected"
				style="width: 25%; text-align: center; float: left; margin-top: 1px; text-align: center;">话题(0)
			</div>
			<div class="essence "
				style="width: 25%; text-align: center; float: left; margin-top: 1px; text-align: center;">精华(0)
			</div>
			<div class="mytopic "
				style="width: 25%; text-align: center; float: left; margin-top: 1px; text-align: center;">我的群发(0)
			</div>
			<div style="clear: both;"></div>
		</div>
		<!-- 成员列表 -->
		<div style="width: 100%;"
			class="user_list  statusDom none">
