...
<script src="<%=path%>/scripts/model/visit_zijie_add.model.js" ></script>
<!-- css files -->
...
<script>
$(function () {
	visit_zijie_add.crmid = '${crmid}';
	visit_zijie_add.openid = '${openid}';
	visit_zijie_add.publicid = '${publicid}';
...
<body>
	...
	<div id="visit_add_container">
		<div id="site-nav" class="navbar" >
			...
			<h3 style="padding-right:45px;">创建服务回访（自接合同）</h3>
		</div>
		<!-- 用户注册流程内容 -->
		<div class="site-card-view ">
			<!-- 提交用户注册数据的表单 -->
			<form name="visit_form" action="<%=path%>/complaint/savevisit_zijie" method="post">
