...
<body style="background-color: rgb(155, 171, 199);">
	<div class="main_bd"
		...
		<form name="addFrm" id="addFrm"	action="<%=path%>/pccomm/save" method="post">
		        <input type="hidden" name="assignerid" value="${aInfo.createBy }" > 
		         <input type="hidden" name="orgId" value="${aInfo.orgId }" > 
		          <input type="hidden" name="filename" value="" > 
		          <input type="hidden" name="typeId" value="${aInfo.typeId }" >
		          <input type="hidden" name="typeName" value="${aInfo.typeName }" >  
		         <input type="hidden" name="status" value="${aInfo.status }" >     
			<div class="media_edit_area"
						...
						<div class="inner">
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">标题</label> <span
									...
									class=" title"  value="${aInfo.title }"></span>
							</div>
							<p>
							...
							<div class="descrition" id="descrition" style="display: none;">
								<label for="" class="frm_label">摘要</label> <span
									class="frm_textarea_box"> <textarea name="descrition"
										...
										class="descrition"  value="${aInfo.descrition }">
										</textarea>
								</span>
							</div>
						...
						<div class="cloudArrow "></div>
								...
								<div id="js_ueditor" class="appmsg_edit_item content_edit">
									<label for="" class="frm_label"> <strong class="news">正文</strong>
										<p class="tips">
											<em id="js_auto_tips">（已载入${aInfo.createTime}的草稿）</em> <a
				...
				<div id="con" class="con" style="display:none;">
				   	<input name="content" id="content" value="${aInfo.content }">
				</div>
