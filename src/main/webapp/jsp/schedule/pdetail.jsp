    ...
    function scheduleReleation(type,oper){
    	...
    	if(type == "opptyList"){
    		...
    		$.ajax({
  		      ...
  		      //async: false,
  		      data: {crmId: '${crmId}',openId:'${openId}',firstchar:firstchar, currpage:currpage,pagecount:pagecount} || {},
  		      dataType: 'text',
  		      success: function(data){
  		    	    var val = '';
  		    	    var d = JSON.parse(data);
    	...
    	p.teamCon.find(".delImg").unbind("click").click(function(){
    		...
    		if(type === "sysuser"){
        		...
        		var dataObj = [], dataObjSec = [];
        	    	...
        	    	dataObj.push({name:'schetype',value:'phone'});
...
<div id="task-create">
	<div id="site-nav" class="navbar">
		...
		<h3 style="padding-right:45px;">电话任务详情</h3>
	</div>
					...
					<input name="participantName" id="participantName" value="${sd.participantname }" type="text" 
					       class="form-control participantChoose"   placeholder="【点击  修改参与人】  >> " readonly="readonly"  >
								...
								<tr>
									...
									<td class="uptInput" style="display:none">
					<input name="contactId" value="" type="hidden" class="form-control" >
					<input name="phonemobile"value="${sd.contactname}" type="text" 
