...
function BasicView(element, calendar, viewName) {
	...
	function buildHeadHTML() {
		...
		for (col=0; col<colCnt; col++) {
			...
			//added by pengmd end 
			html +=
				"<th style='height:30px;' class='fc-day-header fc-" + dayIDs[date.getDay()] + " " + headerClass + "'>" +
	...
	function buildCellHTML(date) {
		...
		//if (showNumbers) {//月视图天数数字显示
			...
			html += "<div class='fc-day-number' style='font-size: 16px;font-weight: bold;text-align: center;padding-top: 5px;'>" + date.getDate() + "<div class='solarday' style='font-size: 8px;color: rgb(190, 190, 190);font-weight: normal;padding-top: 5px;'>"+ cnDay+"</div><div class='holiday'>"+holiday+"</div></div>";
		//} 
		html +=
	...
	function dayBind(days) {
		days.click(dayClick).dblclick(dayDblClick)
