...
(function($){ 
	...
	$.browser={version:(C.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||[0,"0"])[1],safari:/webkit/.test(C),opera:/opera/.test(C),msie:/msie/.test(C)&&!/opera/.test(C),mozilla:/mozilla/.test(C)&&!/(compatible|webkit)/.test(C)};
...
$.fn.htmlbox=function(options){
	...
	var d={
		...
		idir:path+"/scripts/plugin/communication/images/",// HtmlBox Image Directory, This is needed for the images to work
