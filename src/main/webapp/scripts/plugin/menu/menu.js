    ...
    function CloseMetroMenu() {
        ...
        b.MetroMenu = function(a, T) {
            ...
            if (a.position == "top" || a.position == "bottom") {
                var V = '<div align="center" class="MetroMenuBox animated fadeIn fast flooter" style="background-color: ' + a.color1 + ';">';
                ...
                var V = '<div class="MetroMenuBox animated fadeIn fast flooter" style="background-color: ' + a.color1 + ';">';
            ...
            for (var i = 0; i < K; i++) {
                ...
                if (a.items[i].link == undefined) {
                    ...
                    Y += '<img style="display:none" src="' + a.items[i].icon + '" class="MenuIcon" OptionName="' + a.items[i].name + '">';
                    Y += '<span class="MenuOptionText">' + a.items[i].name + "</span>";
                    Y += "</div>"
                } else {
                    Y += '<a href ="' + a.items[i].link + '" style="border-style: none">';
                    //Y += '<div class="MenuOption" id="MenuOption' + i + '" picture="' + a.items[i].icon + '" optionname="' + a.items[i].name + '" submenuitems="' + D + '" SubMenuOptionsNumber="' + I + '" menuoptionI="' + i + '">';
                    Y += '<div class="MenuOption" id="MenuOption' + i + '">';
                    Y += '<img style="display:none" src="' + a.items[i].icon + '" class="MenuIcon" OptionName="' + a.items[i].name + '" style="border-style: none">';
            ...
            function Q() {
                b(".MenuIcon").css("height", "80px");
                b(".MenuOption").css("font-size", "14px");
            ...
            function S(f) {
                f = parseInt(f) + 1;
                b(".SubtitleMenuIcon").css("height", "80px");
                b(".SubMenuOptionBar").css("font-size", "14px");
            ...
            function U() {
                ...
                case "left":
                    ...
                    b(".MetroMenuBox").css("height", "100% auto");
                    b(".MetroMenuBox").css("font-family", "Microsoft YaHei"); 
                    b(".MetroMenuBox").css("width", "75px");
                    b(".MetroMenuBox").css("bottom", "40px");
                ...
                case "right":
                    ...
                    b(".MetroMenuBox").css("width", "75px");
                    b(".MetroMenuBox").css("bottom", "30px");
                    b(".MetroToolTip").css("bottom", "10px");
