...
public class ZJCronExpression {
     ...
     */
    public ZJCronExpression(String cronExpression) throws ParseException {
     ...
     */
    public ZJCronExpression(ZJCronExpression expression) {
        /*
    ...
    public static boolean isValidExpression(String cronExpression) {
        ...
        try {
            new ZJCronExpression(cronExpression);
    ...
    @Deprecated
    public Object clone() {
        return new ZJCronExpression(this);
    }
}
class ValueSet {
    public int value;
