 ...
 *
 */
public class Trackhis extends BaseDtm{
	...
	private String parentName = null; //关联的名称
	...
	private List<Trackhis> his = new ArrayList<Trackhis>();//跟进历史列表
	...
	public List<Trackhis> getHis() {
		return his;
	}
	public void setHis(List<Trackhis> his) {
		this.his = his;
	}
